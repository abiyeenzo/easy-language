...
/* Libere les liaisons propres a cet environnement (pas les valeurs qu'elles
   referencent : listes/textes/fonctions vivent dans leurs propres blocs et
   peuvent avoir survecu via une valeur de retour ou une affectation externe).
   A n'appeler que sur un environnement de portee temporaire (bloc, boucle,
   appel de fonction) dont on est sur qu'aucune fonction definie a l'interieur
   n'est appelee apres coup (pas de fermeture qui s'echappe). */
