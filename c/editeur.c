...
static void mettre_a_jour_titre(HWND hwnd) {
    ...
    if (g_chemin_fichier[0] == L'\0') {
        wcscpy(titre, L"Easy Language 1.0.4 - Editeur [Nouveau fichier]");
    } else {
        _snwprintf(titre, MAX_PATH + 64, L"Easy Language 1.0.4 - Editeur [%s]", g_chemin_fichier);
    }
